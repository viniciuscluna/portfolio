      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
            {t('career.title')} <span className="bg-gradient-to-r from-blue-400 to-cyan-500 bg-clip-text text-transparent">Journey</span>
          </h2>
        ...
        <div className="relative">
          {/* Timeline line */}
          <div className="absolute left-4 md:left-1/2 transform md:-translate-x-px h-full w-0.5 bg-gradient-to-b from-blue-500 to-cyan-500"></div>
              ...
              <div className="ml-12 md:ml-0 md:w-1/2 md:pr-8 md:text-right">
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-all duration-300">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-blue-400 text-sm font-medium">{t('career.mercadolibre.period')}</span>
                  ...
                  <p className="text-blue-400 font-medium mb-3">{t('hero.currentCompany')}</p>
                  ...
                  <div className="flex flex-wrap gap-2 mt-4">
                    ...
                    <span className="px-3 py-1 bg-blue-500/20 text-blue-300 rounded-full text-xs">Microservices</span>
              ...
              <div className="ml-12 md:ml-0 md:w-1/2 md:ml-auto md:pl-8">
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-all duration-300">
                  ...
                  <div className="flex flex-wrap gap-2 mt-4">
                    ...
                    <span className="px-3 py-1 bg-blue-500/20 text-blue-300 rounded-full text-xs">Azure</span>
              ...
              <div className="ml-12 md:ml-0 md:w-1/2 md:pr-8 md:text-right">
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-all duration-300">
                  ...
                  <div className="flex flex-wrap gap-2 mt-4">
                    ...
                    <span className="px-3 py-1 bg-blue-500/20 text-blue-300 rounded-full text-xs">Business Analysis</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="mt-20">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 hover:bg-white/10 transition-all duration-300">
              ...
              <p className="text-blue-400 font-medium mb-2">FIAP</p>
